...
<div size='20px'> Hi! My name is Franco Alfano. Thank You for taking the time to view my GitHub Profile :smile: 
</div>
...
- 🔭 I’m currently working on Actualmente, estoy estudiando en Henry, desarrollando con un grupo de estudiantes el proyecto final del bootcamp. Se trata de una plataforma de videos adaptable a una empresa o academia que requiera conectar y comunicarse con una comunidad mediante videos.

- 🌱 I’m currently learning Para este proyecto estoy aprendiendo a trabajar con autenticación de Google y con pasarelas de pagos. 
...
<a target="_blank" href = 'https://www.linkedin.com/in/franco-alfano-4a6a7b216'> <img width = '32px' align= 'center' src="https://raw.githubusercontent.com/rahulbanerjee26/githubAboutMeGenerator/main/icons/linked-in-alt.svg"/></a> 
...
![Metrics](https://metrics.lecoq.io/#88412878?template=terminal&base.header=0&base.activity=0&base.repositories=0&base.metadata=0&languages=1&languages.limit=8&languages.colors=github&languages.threshold=0%25&config.timezone=America%2FToronto)
